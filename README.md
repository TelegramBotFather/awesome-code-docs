...
## 📈 Trending Vibe-Coding Repos (Auto-updated 2026-04-20)
...
|:---------------|:---------|------:|:----------|:---------------|
| [`anomalyco/opencode`](https://github.com/anomalyco/opencode) | [OpenCode Tutorial](tutorials/opencode-tutorial/) | 146,278 | 2026-04-20 (0d ago) | terminal-native coding agent with strong provider and tool controls |
| [`open-webui/open-webui`](https://github.com/open-webui/open-webui) | [Open WebUI Tutorial](tutorials/open-webui-tutorial/) | 132,770 | 2026-04-20 (0d ago) | self-hosted AI interface and model operations |
| [`browser-use/browser-use`](https://github.com/browser-use/browser-use) | [Browser Use Tutorial](tutorials/browser-use-tutorial/) | 88,818 | 2026-04-19 (1d ago) | browser-native AI automation and agent execution |
| [`daytonaio/daytona`](https://github.com/daytonaio/daytona) | [Daytona Tutorial](tutorials/daytona-tutorial/) | 72,385 | 2026-04-20 (0d ago) | sandbox infrastructure for secure AI code execution |
| [`cline/cline`](https://github.com/cline/cline) | [Cline Tutorial](tutorials/cline-tutorial/) | 60,471 | 2026-04-20 (0d ago) | agentic coding with terminal, browser, and MCP workflows |
| [`Mintplex-Labs/anything-llm`](https://github.com/Mintplex-Labs/anything-llm) | [AnythingLLM Tutorial](tutorials/anything-llm-tutorial/) | 58,636 | 2026-04-17 (3d ago) | self-hosted RAG workspaces and agent workflows |
| [`Fission-AI/OpenSpec`](https://github.com/Fission-AI/OpenSpec) | [OpenSpec Tutorial](tutorials/openspec-tutorial/) | 41,408 | 2026-04-20 (0d ago) | spec-driven workflow layer for predictable AI-assisted delivery |
| [`TabbyML/tabby`](https://github.com/TabbyML/tabby) | [Tabby Tutorial](tutorials/tabby-tutorial/) | 33,447 | 2026-03-02 (49d ago) | self-hosted coding assistant platform for teams |
| [`continuedev/continue`](https://github.com/continuedev/continue) | [Continue Tutorial](tutorials/continue-tutorial/) | 32,667 | 2026-04-20 (0d ago) | IDE-native AI coding assistant architecture |
| [`vercel/ai`](https://github.com/vercel/ai) | [Vercel AI SDK Tutorial](tutorials/vercel-ai-tutorial/) | 23,635 | 2026-04-20 (0d ago) | production TypeScript AI app and agent SDK patterns |
| [`RooCodeInc/Roo-Code`](https://github.com/RooCodeInc/Roo-Code) | [Roo Code Tutorial](tutorials/roo-code-tutorial/) | 23,218 | 2026-04-20 (0d ago) | multi-mode coding agents and approval workflows |
| [`dyad-sh/dyad`](https://github.com/dyad-sh/dyad) | [Dyad Tutorial](tutorials/dyad-tutorial/) | 20,151 | 2026-04-18 (2d ago) | local-first AI app generation workflows |
| [`stackblitz-labs/bolt.diy`](https://github.com/stackblitz-labs/bolt.diy) | [bolt.diy Tutorial](tutorials/bolt-diy-tutorial/) | 19,272 | 2026-02-07 (72d ago) | open-source Bolt-style product builder stack |
| [`sweepai/sweep`](https://github.com/sweepai/sweep) | [Sweep Tutorial](tutorials/sweep-tutorial/) | 7,714 | 2025-09-18 (214d ago) | issue-to-PR coding agent workflows and GitHub automation |
| [`stagewise-io/stagewise`](https://github.com/stagewise-io/stagewise) | [Stagewise Tutorial](tutorials/stagewise-tutorial/) | 6,596 | 2026-04-20 (0d ago) | browser-context frontend coding agent workflows |
| [`cloudflare/vibesdk`](https://github.com/cloudflare/vibesdk) | [VibeSDK Tutorial](tutorials/vibesdk-tutorial/) | 4,958 | 2026-04-15 (5d ago) | Cloudflare-native prompt-to-app platform architecture |
