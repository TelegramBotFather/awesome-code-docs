...
- stars: about **51.4k**
- latest release: [`v12.1.0`](https://github.com/thedotmack/claude-mem/releases/tag/v12.1.0) (published 2026-04-09)
...
2. [Chapter 2: Architecture, Hooks, and Worker Flow](02-architecture-hooks-and-worker-flow.md)
3. [Chapter 3: Installation, Upgrade, and Runtime Environment](03-installation-upgrade-and-runtime-environment.md)
4. [Chapter 4: Configuration, Modes, and Context Injection](04-configuration-modes-and-context-injection.md)
5. [Chapter 5: Search Tools and Progressive Disclosure](05-search-tools-and-progressive-disclosure.md)
6. [Chapter 6: Viewer Operations and Maintenance Workflows](06-viewer-operations-and-maintenance-workflows.md)
7. [Chapter 7: Troubleshooting, Recovery, and Reliability](07-troubleshooting-recovery-and-reliability.md)
