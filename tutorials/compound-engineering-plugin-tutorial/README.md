...
- stars: about **14.2k**
- latest release: [`compound-engineering-v2.65.0`](https://github.com/EveryInc/compound-engineering-plugin/releases/tag/compound-engineering-v2.65.0) (published 2026-04-11)
...
2. [Chapter 2: Compound Engineering Philosophy and Workflow Loop](02-compound-engineering-philosophy-and-workflow-loop.md)
3. [Chapter 3: Architecture of Agents, Commands, and Skills](03-architecture-of-agents-commands-and-skills.md)
4. [Chapter 4: Multi-Provider Conversion and Config Sync](04-multi-provider-conversion-and-config-sync.md)
5. [Chapter 5: MCP Integrations and Browser Automation](05-mcp-integrations-and-browser-automation.md)
6. [Chapter 6: Daily Operations and Quality Gates](06-daily-operations-and-quality-gates.md)
7. [Chapter 7: Troubleshooting and Runtime Maintenance](07-troubleshooting-and-runtime-maintenance.md)
8. [Chapter 8: Contribution Workflow and Versioning Discipline](08-contribution-workflow-and-versioning-discipline.md)
