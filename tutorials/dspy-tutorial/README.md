...
- stars: about **34k**
- latest release: [`3.2.0`](https://github.com/stanfordnlp/dspy/releases/tag/3.2.0) (published 2026-04-21)
...
1. [Chapter 1: Getting Started with DSPy](01-getting-started.md)
2. [Chapter 2: Signatures - Defining LM Input/Output Behavior](02-signatures.md)
3. [Chapter 3: Modules - Reusable DSPy Components](03-modules.md)
4. [Chapter 4: Retrieval-Augmented Generation (RAG) with DSPy](04-rag.md)
5. [Chapter 5: Automatic Optimization - DSPy's Superpower](05-optimization.md)
6. [Chapter 6: Advanced Patterns - Multi-Hop Reasoning and Tool Integration](06-advanced-patterns.md)
7. [Chapter 7: Evaluation & Metrics - Systematic Assessment of DSPy Programs](07-evaluation.md)
8. [Chapter 8: Production Deployment - Scaling DSPy Systems](08-production.md)
