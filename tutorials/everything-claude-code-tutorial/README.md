...
[![GitHub Repo](https://img.shields.io/badge/GitHub-affaan--m%2Feverything--claude--code-black?logo=github)](https://github.com/affaan-m/everything-claude-code)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/affaan-m/everything-claude-code/blob/main/LICENSE)
[![Release](https://img.shields.io/badge/release-v1.5.0-green)](https://github.com/affaan-m/everything-claude-code/releases/tag/v1.5.0)
...
- stars: about **154k**
- latest release: [`v1.10.0`](https://github.com/affaan-m/everything-claude-code/releases/tag/v1.10.0) (published 2026-04-05)
