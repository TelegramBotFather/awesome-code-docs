...
- stars: about **133k**
- latest release: [`langchain-core==1.3.0a1`](https://github.com/langchain-ai/langchain/releases/tag/langchain-core==1.3.0a1) (published 2026-04-10)
...
1. [Chapter 1: Getting Started -- Ecosystem Overview](01-getting-started.md)
2. [Chapter 2: The Runnable Interface (LCEL)](02-runnable-interface.md)
3. [Chapter 3: Chat Model Architecture](03-chat-model-architecture.md)
4. [Chapter 4: Chain Composition](04-chain-composition.md)
5. [Chapter 5: Document Loading & Splitting](05-document-loading-splitting.md)
6. [Chapter 6: Vector Store Abstraction](06-vector-store-abstraction.md)
7. [Chapter 7: Agent Architecture](07-agent-architecture.md)
8. [Chapter 8: Production Patterns](08-production-patterns.md)
