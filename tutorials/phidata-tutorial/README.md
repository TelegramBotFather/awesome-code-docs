...
- stars: about **39.4k**
- latest release: [`v2.5.16`](https://github.com/phidatahq/phidata/releases/tag/v2.5.16) (published 2026-04-10)
...
1. [Chapter 1: Getting Started with Phidata Agents](01-getting-started.md)
2. [Chapter 2: Understanding Phidata Agent Architecture](02-agent-architecture.md)
3. [Chapter 3: Tools & Functions - Extending Agent Capabilities](03-tools-functions.md)
4. [Chapter 4: Memory Systems - Building Context-Aware Agents](04-memory-systems.md)
5. [Chapter 5: Multi-Agent Systems - Coordinating Teams of AI Agents](05-multi-agent-systems.md)
6. [Chapter 6: Advanced Reasoning - Complex Decision Making and Problem Solving](06-advanced-reasoning.md)
7. [Chapter 7: Integrations - Connecting Phidata Agents to External Systems](07-integrations.md)
8. [Chapter 8: Production Deployment & Scaling Phidata Agents](08-production-deployment.md)
