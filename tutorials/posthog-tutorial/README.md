...
- stars: about **34.1k**
- latest release: [`posthog-cli/v0.7.10`](https://github.com/PostHog/posthog/releases/tag/posthog-cli/v0.7.10) (published 2026-04-23)
...
1. [Chapter 1: Getting Started with PostHog](01-getting-started.md)
2. [Chapter 2: Event Tracking & Properties](02-event-tracking.md)
3. [Chapter 3: User Analytics & Funnels](03-user-analytics.md)
4. [Chapter 4: Session Recordings](04-session-recordings.md)
5. [Chapter 5: Feature Flags & Experiments](05-feature-flags.md)
6. [Chapter 6: Dashboards & Insights](06-dashboards-insights.md)
7. [Chapter 7: Advanced Analytics](07-advanced-analytics.md)
